...
export function generateStoryDeepLink(
  ...
  return `https://monitor.neuralnewscast.com/api/story?${params.toString()}`;
}
...
export const shareTexts = {
  ...
  linkedin: (data: StoryData) =>
    ...
    `\nData via Neural Newscast and World Monitor - Open source geopolitical intelligence`,
